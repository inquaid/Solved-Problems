...
const int ITER = 1; // select the number of iterations
...
int32_t main() {
  ...
  for (int t = 1; t <= ITER; t++) {
    ...
    string in = "input.txt";
    // Modified execution commands with ./ prefix
    string generator_cmd = "./generator > input.txt";
    system(generator_cmd.c_str()); // generating a case
